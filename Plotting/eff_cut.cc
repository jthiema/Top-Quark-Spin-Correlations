...
void eff_cut(str item){
    ...
    TH1F *h_reco = (TH1F*) minitree->Get(item);
    TH1F *h_gen = (TH1F*) minitree->Get("gen_"+item+"_0"); 
    TH1F *h_ratio = (TH1F*) h_reco->Clone("rvg_"+item); 
    ...
    c1->SaveAs("effvscut/effvscut_reco_vs_allgen"+item+".png");
    minitree->Close(); 
