...
hmetpt = ROOT.TH1D('met_pt', 'met_pt', 30, 0, 600)
...
hgenmetpt = ROOT.TH1D('gen_met_pt', 'gen_met_pt', 30, 0, 600)
...
hgenatpt = ROOT.TH1D('gen_at_pt', 'gen_at_pt', 30, 0, 600)
...
hrvgtpt = ROOT.TH2D('rvg_t_pt', 'reco vs gen t pt', 30, 0, 300, 30, 0, 300)
...
hrvgatpt = ROOT.TH2D('rvg_at_pt', 'reco vs gen at pt', 30, 0, 300, 30, 0, 300)
