...
for i in range(len(h_b1k_arr)):
    ...
    h_bP_kk_arr = h_bP_kk[i]
    h_bM_kk_arr = h_bM_kk[i]
    h_bP_jj_arr = h_bP_jj[i]
    h_bM_jj_arr = h_bM_jj[i]
    h_bP_rr_arr = h_bP_rr[i]
    h_bM_rr_arr = h_bM_rr[i]
    h_bP_qq_arr = h_bP_qq[i]
    h_bM_qq_arr = h_bM_qq[i]
    h_bP_nn_arr = h_bP_nn[i]
    h_bM_nn_arr = h_bM_nn[i]
